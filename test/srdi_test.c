...
Jxta_boolean srdi_ttl_test(Jxta_SRDIMessage * ad)
{
...
Jxta_boolean srdi_get_primaryKey_test(Jxta_SRDIMessage * ad)
{
...
Jxta_boolean srdi_get_peerid_test(Jxta_SRDIMessage * ad)
{
...
Jxta_boolean srdi_entry_test(Jxta_SRDIMessage * ad)
{
    Jxta_vector *entries;
    int i;
    int num;
